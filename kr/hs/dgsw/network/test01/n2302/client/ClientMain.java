package kr.hs.dgsw.network.test01.n2302.client;
...
public class ClientMain {
        ...
        if(operator.contains("/업로드")){
            if(operator.contains(" ")){
                ...
                if(tokenList.length == 2){
                    ...
                    return "업로드>"+tokenList[tokenList.length-1]+" "+filePath[filePath.length-1];
                }
    ...
    public static void fileUpload(String list, Socket sc, BufferedReader br) throws IOException {
...
//        dos.flush();
    ...
    public static void download(String bool, Socket sc, BufferedReader br) throws IOException {
        ...
        if(token[0].equals("true")){
            ...
            File file = new File("/Users/seonghun/공부/spring/network/src/kr/hs/dgsw/network/test01/n2302/client/"+token[1]);
